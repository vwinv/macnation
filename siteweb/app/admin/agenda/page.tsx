...
import AdminWalkInBooking from "@/components/admin/AdminWalkInBooking";
      ...
      <div className="flex flex-wrap items-end justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <button
            ...
            className="btn-gold h-10 cursor-pointer rounded-lg px-4 text-sm font-medium"
          >
            Nouveau RDV
          </button>
          <button
            ...
            className="h-10 cursor-pointer rounded-lg bg-gray-900 px-4 text-sm text-black ring-1 ring-black/10 hover:bg-gray-200"
          >
            Paramétrages
          </button>
